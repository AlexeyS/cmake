...
IF(MSVC_VERSION GREATER 1310)
  ...
  IF(CMAKE_UNDER_CE)
    SET (CMAKE_PLATFORM_DEFINES "/D_WIN32_WCE=$(CEVER) /DUNDER_CE /D$(ARCHFAM) /D$(_ARCHFAM_) /D$(PLATFORMDEFINES) /D_WINDOWS /DUNICODE /D_UNICODE")
    SET (CMAKE_C_STANDARD_LIBRARIES_INIT "coredll.lib corelibc.lib ole32.lib oleaut32.lib uuid.lib commctrl.lib ")
    SET (CMAKE_CRT_LINKAGE "/MT")
    SET (CMAKE_CRT_LINKAGE_DEBUG "/MTd")
  ELSE(CMAKE_UNDER_CE)
    SET (CMAKE_PLATFORM_DEFINES "/DWIN32 /D_WINDOWS")
    SET (CMAKE_C_STANDARD_LIBRARIES_INIT "kernel32.lib user32.lib gdi32.lib winspool.lib shell32.lib ole32.lib oleaut32.lib uuid.lib comdlg32.lib advapi32.lib ")
    SET (CMAKE_CRT_LINKAGE "/MD")
    SET (CMAKE_CRT_LINKAGE_DEBUG "/MDd")
  ENDIF(CMAKE_UNDER_CE)
  SET (CMAKE_CXX_FLAGS_INIT "${CMAKE_PLATFORM_DEFINES} /W3 /Zm1000 /EHsc /GR")
  SET (CMAKE_CXX_FLAGS_DEBUG_INIT "/D_DEBUG ${CMAKE_CRT_LINKAGE_DEBUG} /Zi /Ob0 /Od /RTC1")
  SET (CMAKE_CXX_FLAGS_MINSIZEREL_INIT "${CMAKE_CRT_LINKAGE} /O1 /Ob1 /D NDEBUG")
  SET (CMAKE_CXX_FLAGS_RELEASE_INIT "${CMAKE_CRT_LINKAGE} /O2 /Ob2 /D NDEBUG")
  SET (CMAKE_CXX_FLAGS_RELWITHDEBINFO_INIT "${CMAKE_CRT_LINKAGE} /Zi /O2 /Ob1 /D NDEBUG")
  SET (CMAKE_C_FLAGS_INIT "${CMAKE_PLATFORM_DEFINES} /W3 /Zm1000")
  SET (CMAKE_C_FLAGS_DEBUG_INIT "/D_DEBUG ${CMAKE_CRT_LINKAGE_DEBUG} /Zi  /Ob0 /Od /RTC1")
  SET (CMAKE_C_FLAGS_MINSIZEREL_INIT "${CMAKE_CRT_LINKAGE} /O1 /Ob1 /D NDEBUG")
  SET (CMAKE_C_FLAGS_RELEASE_INIT "${CMAKE_CRT_LINKAGE} /O2 /Ob2 /D NDEBUG")
  SET (CMAKE_C_FLAGS_RELWITHDEBINFO_INIT "${CMAKE_CRT_LINKAGE} /Zi /O2 /Ob1 /D NDEBUG")
...
IF(CMAKE_UNDER_CE AND MSVC90)
  SET(CMAKE_CXX_FLAGS_DEBUG_INIT "${CMAKE_CXX_FLAGS_DEBUG_INIT} /D DEBUG")
ENDIF(CMAKE_UNDER_CE AND MSVC90)
